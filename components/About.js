  ...
  return (
    <section className='text-center' id='about-us'>
      <div className='pt-[2%] text-[#214733]' data-aos="fade-up"
        ...
        <h2 className='m-5 text-xl md:text-2xl font-semibold'>Primary line of business is Importer-Distributor of NUTRITION & HEALTH,
          ingredients such as Botanical Extracts & Powders.</h2>
      </div>
      <div>
        <div className="container mx-auto lg:lg:space-y-12 pt-0 lg:pt-[4em]">
          <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
            ...
            <div className="flex flex-col justify-center flex-1 p-6" data-aos="fade-left" data-aos-delay="300" data-aos-anchor-placement="bottom-bottom">
              ...
              <p className="md:text-xl lg:text-2xl my-2 lg:my-2 lg:my-6 lg:mx-20 font-semibold text-[#214733]">{component.data[1].attributes.uniqueinput} <br /> <span className='font-bold'>{component.data[1].attributes.description}</span> {component.data[1].attributes.uniqueinput2}
              </p>
            </div>
          </div>
          <div>
